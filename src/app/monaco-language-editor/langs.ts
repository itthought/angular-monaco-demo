...
`,
    ...
    lsp: {
      ...
      init: {
        ...
        bundles: [
          '/opt/jdt/bundles/com.microsoft.java.test.plugin-0.25.0.jar',
          '/opt/jdt/bundles/com.microsoft.jdtls.ext.core-0.14.0.jar',
...
`,
  ...
  python: {
    aliases: ['python', 'python2', 'py'],
    name: 'Python',
    monacoLang: 'python',
    repl: 'python -u',
    main: 'main.py',
    run: 'python -u -i main.py',
    scope: {
      code: `x = 123 * 234`,
    },
    format: {
...
`,
    ...
    pkg: {
      ...
      search: `python -c 'import json; from xmlrpc import client; print(json.dumps(client.ServerProxy("https://pypi.org/pypi").search({"name": "NAME"})))' | jq -r 'map(.name) | .[]'`,
    },
    lsp: {
